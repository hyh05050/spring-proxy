...
public class ProxyFactoryConfigV2 {
    ...
    public OrderControllerV2 orderControllerV2(LogTrace logTrace) {
        ...
        log.info("Factory proxy={} target={}", proxy.getClass(), orderControllerV2.getClass());
        return proxy;
    }
    ...
    public OrderServiceV2 orderServiceV2(LogTrace logTrace) {
        ...
        log.info("Factory proxy={} target={}", proxy.getClass(), orderServiceV2.getClass());
        return proxy;
    }
    ...
    public OrderRepositoryV2 orderRepositoryV2(LogTrace logTrace) {
        ...
        log.info("Factory proxy={} target={}", proxy.getClass(), orderRepositoryV2.getClass());
        return proxy;
    }
